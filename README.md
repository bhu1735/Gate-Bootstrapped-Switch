...
# Netlist:  
The netlist for inverter can be found here: [Netlist_Inverter.txt](https://github.com/bhu1735/Gate-Bootstrapped-Switch/files/8164538/Netlist_Inverter.txt). It is also shown below for reference:  
